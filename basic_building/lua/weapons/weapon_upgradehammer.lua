...
local required = BasicBuilding.UpgradeLevels[1].cost
local maxdist = 256
...
function SWEP:SecondaryAttack()
	...
	if SERVER and IsValid(self.Owner) then
		...
		local block = BasicBuilding.UpgradeLevels[trent:GetNWInt("upgrade_level", 1)]
		local next_block = BasicBuilding.UpgradeLevels[trent:GetNWInt("upgrade_level", 1) + 1]
