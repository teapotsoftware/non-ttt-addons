...
SWEP.Category = "Basic Building"
SWEP.Instructions = "<color=green>[PRIMARY FIRE]</color> Place an object\n<color=green>[SECONDARY FIRE]</color> Choose object"
...
local default_cost = BasicBuilding.UpgradeLevels[1].cost
local maxdist = 256
...
function SWEP:PrimaryAttack()
	...
	if SERVER and IsValid(self.Owner) then
		...
		prop:SetNWInt("block_health", BasicBuilding.UpgradeLevels[1].health * obj.health_multiplier)
		prop:SetMaterial(BasicBuilding.UpgradeLevels[1].mat)
